...
try{
	...
	sql = " SELECT                                                            ";                                                                                                                             
	sql += "      '' AS YYYY, '' AS NM_FINAL, SUM (FINAL_AREA) AS FINAL_AREA,  ";
	...
	sql += "                  FROM POLLULANT_LOAD_FOR_SMAT                     ";
	sql += "      UNION                                                        ";                                     
	sql += "      SELECT YYYY,  NM_FINAL,    FINAL_AREA,                                  ";   
	sql += "      GNR_FLOW_SUM ,                                               ";                          
	sql += "      GNR_FLOW_POP                    ,                            ";                                     
	sql += "      GNR_FLOW_ANI          ,                                      ";                                     
	sql += "      GNR_FLOW_IND          ,                                      ";                                     
	...
	sql += "      OUT_TP_LAND           ,                                      ";                                     
	sql += "      OUT_TP_FISH           ,                                      ";                                     
	sql += "      OUT_TP_LANDFILL         FROM        POLLULANT_LOAD_FOR_SMAT  ";
	sql += "    ORDER BY YYYY                                                                         ";
   ...
   rs = stmt.executeQuery(sql);
	...
	while(rs.next()) {
		...
		jsonRecord.put("NM_FINAL",rs.getString("NM_FINAL"));
