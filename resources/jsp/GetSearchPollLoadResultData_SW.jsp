...
try{
	...
	//FINAL_AREA
	sql = " SELECT                                                                                   ";                                                                                           
	sql += "         '' AS YYYY, '' AS SW_CODE,    '' AS WS_NM , '' AS AM_NM, '' AS SW_NAME,            ";
	sql += "         SUM ( FINAL_AREA ) AS FINAL_AREA ,                                           ";
	...
	sql += "         FROM  POLLULANT_LOAD_FOR_SW     WHERE                                                  ";
	if(sw2 == ""){
	...
	sql += "         UNION                                                                            ";    
	sql += "         SELECT YYYY,  SW_CODE,   WS_NM ,  AM_NM,  SW_NAME,   FINAL_AREA,         ";
	sql += "         GNR_FLOW_SUM ,                                                                   ";
	sql += "         GNR_FLOW_POP                    ,                                                ";    
	sql += "         GNR_FLOW_ANI          ,                                                          ";    
	sql += "         GNR_FLOW_IND          ,                                                          ";    
...
//  
		...
		jsonRecord.put("SW_CODE",rs.getString("SW_CODE"));
		...
		jsonRecord.put("FINAL_AREA",rs.getString("FINAL_AREA"));
