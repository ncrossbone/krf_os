...
//                { text: 'Cascade', handler: me.cascadeWindows, scope: me, minWindows: 1 }
    ...
    createWindowMenu: function () {
        ...
        return {
            defaultAlign: 'br-tr',
            items: [
                { text: '열기', handler: me.onWindowMenuRestore, scope: me },
                { text: '최소화', handler: me.onWindowMenuMinimize, scope: me },
                { text: '최대화', handler: me.onWindowMenuMaximize, scope: me },
                '-',
                { text: '닫기', handler: me.onWindowMenuClose, scope: me }
            ],
            listeners: {
