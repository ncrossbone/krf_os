...
try{
	...
	sql += "              , CAT_DID                                                                               ";
	sql += "              , ADDR /* 시도(법정동) */                                                               ";
	sql += "              , TO_CHAR(FINAL_PERCENTAGE) AS FINAL_PERCENTAGE                                         ";
	...
	sql += "          GROUP BY YYYY, WS_NM, MB_NM, SB_NM, SB_ID, CAT_DID, ADM_CD, ADDR, FINAL_PERCENTAGE          ";
	sql += "         UNION                                                                                        ";
	sql += "         SELECT YYYY /* 조사년도 */                                                                   ";
	sql += "              , WS_NM                                                                                 ";
	sql += "              , MB_NM                                                                                 ";
	...
	sql += "           FROM TBL_PLA_FISHFARM_TOTAL                                                                ";
	sql += "        )                                                                                             ";
	sql += "  ORDER BY DECODE(ADDR,'총계',1,2), SB_ID, CAT_DID, DECODE(ADDR,'소계',1,2), ADDR                     ";
...
rs = stmt.executeQuery(sql);
	...
	while(rs.next()) {
		...
		jsonRecord.put("YYYY",rs.getString("YYYY"));//FINAL_PERCENTAGE
		...
		jsonRecord.put("FINAL_PERCENTAGE",rs.getString("FINAL_PERCENTAGE"));//FINAL_PERCENTAGE
