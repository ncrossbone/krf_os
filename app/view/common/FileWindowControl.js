Ext.define('krf_new.view.common.FileWindowControl', {

	extend: 'Ext.window.Window',
	xtype: 'common-filewindowcontrol',
	//cls: 'khLee-x-tab-active',

	/* option으로 받아올 부분
	 * 없으면 아래 기본값 */
	id: 'FileWindowControl',
	title: 'Window',
	...
	initComponent: function () {
		...
		this.on("beforeclose", function (window) {
			...
			var searchFileResultWindow = Ext.getCmp("searchFileResultWindow");
			searchFileResultWindow.hide();
			return false;
		});
	},
