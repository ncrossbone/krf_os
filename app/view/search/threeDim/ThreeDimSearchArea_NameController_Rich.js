Ext.define('krf_new.view.search.threeDim.ThreeDimSearchArea_NameController_Rich', {

	extend: 'Ext.app.ViewController',

	alias: 'controller.threeDimSearchArea_NameController_Rich',
	...
	control: {
		...
		'#textSearchText_Start': {
			specialkey: function (f, e) {
				var btnSearchText_Start = Ext.getCmp("btnThreeDimSearchText_Start");
				if (e.getKey() == e.ENTER) {
		...
		'#textSearchText_End': {
			specialkey: function (f, e) {
				var btnSearchText_End = Ext.getCmp("btnThreeDimSearchText_End");
				if (e.getKey() == e.ENTER) {
	...
	onTextSearch: function (button, eOpts) {
		...
		var textSearchText_Start = Ext.getCmp("textThreeDimSearchText_Start");
		var textSearchText_End = Ext.getCmp("textThreeDimSearchText_End");

		if (button.id == "btnThreeDimSearchText_Start") {
		...
		queryTask.execute(query, function (result) {
			Ext.each(result, function (objLayer, idx, objLayers) {
				...
				var listCtl = Ext.getCmp("searchThreeDimAreaList");
				listCtl.removeAll();
				listCtl.doLayout();
				...
				var listCtl_Total = Ext.getCmp("searchThreeDimAreaList_Total");
		...
		var btnCtl = null;
		var btn = Ext.getCmp("btnThreeDimSearchText_Start");
		var searchAreaContents_1 = Ext.getCmp("searchThreeDimAreaContents_1");
