Ext.define('krf_new.view.drone.map.DroneFeatureLayerAdmin1', {
	map:null, 
	layer:null,
	dynamicLayer1:null,
	dynamicLayer2:null,
	...
	constructor: function(map,itemValue) {
        ...
        var queryTask = new esri.tasks.QueryTask($KRF_DEFINE.MapserviceUrl1 + "/" + $KRF_DEFINE.featureLayerId); // 레이어 URL
