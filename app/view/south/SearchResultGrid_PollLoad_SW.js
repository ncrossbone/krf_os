Ext.define('krf_new.view.south.SearchResultGrid_PollLoad_SW', {
	...
	items: [{
		...
		items: [{
			...
			columns: [{	 
				...
				width: 150
				//filter: {type: 'numeric'}
			},{text:'발생BOD합계',dataIndex:'GNR_BOD_SUM',with:150}//filter:{type:numeric'}
			,{text:'발생TN합계',dataIndex:'GNR_TN_SUM',with:150}//filter:{type:numeric'}
			,{text:'발생TP합계',dataIndex:'GNR_TP_SUM',with:150}//filter:{type:numeric'}
			,{text:'발생유량합계',dataIndex:'GNR_FLOW_SUM',with:150}//filter:{type:numeric'}
			,{text:'배출유량합계',dataIndex:'IND_OUT_FLOW_SUM',with:150}//filter:{type:numeric'}
			,{text:'배출BOD합계',dataIndex:'IND_OUT_BOD_SUM',with:150}//filter:{type:numeric'}
			,{text:'배출TN합계',dataIndex:'IND_OUT_TN_SUM',with:150}//filter:{type:numeric'}
			,{text:'배출TP합계',dataIndex:'IND_OUT_TP_SUM',with:150}//filter:{type:numeric'}
