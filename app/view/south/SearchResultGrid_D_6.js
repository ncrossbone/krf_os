Ext.define('krf_new.view.south.SearchResultGrid_D_6', {
							...
							tipTpl: new Ext.XTemplate(
							    ...
							    '</tpl>',
							    {
							        ...
							        formatY: function(yVal){
							        	yVal = Ext.util.Format.number(yVal, $KRF_APP.global.AttrFn.getAttrFormat(this.config.layerId,'RND'));
							            return yVal;
							        }
							    }
							),
						...
						widget: {
							...
							tipTpl: new Ext.XTemplate(
							    ...
							    '</tpl>',
							    {
							    	formatX: $KRF_APP.global.CommFn.dateFormatter,
							        formatY: function(yVal){
							        	yVal = Ext.util.Format.number(yVal, $KRF_APP.global.AttrFn.getAttrFormat(this.config.layerId,'SIDAY'));
							            return yVal;
							        }
							    }
							),
