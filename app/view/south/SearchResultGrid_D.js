Ext.define('krf_new.view.south.SearchResultGrid_D', {
							...
							tipTpl: new Ext.XTemplate(
							    ...
							    '</tpl>',
							    {
							        ...
							        formatY: function(yVal){
							        	yVal = Ext.util.Format.number(yVal, $KRF_APP.global.AttrFn.getAttrFormat(this.config.layerId,'WL'));
							            return yVal;
							        }
							    }
							),
						...
						widget: {
							...
							tipTpl: new Ext.XTemplate(
							    ...
							    '</tpl>',
							    {
							    	formatX: $KRF_APP.global.CommFn.dateFormatter,
							        formatY: function(yVal){
							        	yVal = Ext.util.Format.number(yVal, $KRF_APP.global.AttrFn.getAttrFormat(this.config.layerId,'MXWL'));
							            return yVal;
							        }
							    }
							),
						...
						widget: {
							...
							tipTpl: new Ext.XTemplate(
							    ...
							    '</tpl>',
							    {
							    	formatX: $KRF_APP.global.CommFn.dateFormatter,
							        formatY: function(yVal){
							        	yVal = Ext.util.Format.number(yVal, $KRF_APP.global.AttrFn.getAttrFormat(this.config.layerId,'MNXL'));
							            return yVal;
							        }
							    }
							),
