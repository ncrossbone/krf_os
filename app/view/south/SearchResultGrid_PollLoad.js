Ext.define('krf_new.view.south.SearchResultGrid_PollLoad', {
	...
	items: [{
		...
		items: [{
			...
			,{text:'배출유량합계',dataIndex:'IND_OUT_FLOW_SUM',width:150}//filter:{type:numeric'}
			,{text:'배출BOD합계',dataIndex:'IND_OUT_BOD_SUM',width:150}//filter:{type:numeric'}
			,{text:'배출TN합계',dataIndex:'IND_OUT_TN_SUM',width:150}//filter:{type:numeric'}
			,{text:'배출TP합계',dataIndex:'IND_OUT_TP_SUM',width:150}//filter:{type:numeric'}
