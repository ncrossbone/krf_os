<%@page import="com.clipsoft.clipreport.server.service.ClipReportPDFForCAB"%>
...
ResultValue result = ClipReportPDFForCAB.create(request, propertyPath, oof.toString());
